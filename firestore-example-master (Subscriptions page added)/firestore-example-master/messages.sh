...
PROJECT_ID='year2project-93756'
COLLECTION_ID='Genre'
API_KEY='AIzaSyDTRj_yXju2fOO0J3G_02vyZPkYRz0HkdU'
TOKEN=''
...
do
        ...
        # assume topic has 4 fields in form field1/field2/field3/field4 //  now has 5 fields in form field1 - field5
        ...
        JSON='{"fields": {"createdAt": {"stringValue": "'"$now"'"}, "sender": {"stringValue": "'"$sender"'"}, "subject": {"stringValue": "'"$subject"'"}, "message": {"stringValue": "'"$message"'"}, "Genre": {"stringValue": "'"$Genre"'"}}}'
        echo $JSON
