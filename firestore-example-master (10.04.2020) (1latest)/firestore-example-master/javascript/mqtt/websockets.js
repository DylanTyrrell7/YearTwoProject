...
const defaultDestinationTopic = 'messageapp/sender/createdAt/subject/message/Genre';
...
function sendMessage() {
  ...
  const Genres = document.getElementById("messageText").value;  

  // Construct message
  const payload = `'${sender}'${msgDelimiter}'${moment().format('lllll').replace(/,/g, ' ')}'${msgDelimiter}'${subject}'${msgDelimiter}'${messageText}'${Genres}'`;
